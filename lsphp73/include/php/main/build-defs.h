...
#define PHP_EXTENSION_DIR       "/usr/local/lsws/lsphp73/lib/php/20180731"
#define PHP_PREFIX              "/usr/local/lsws/lsphp73"
#define PHP_BINDIR              "/usr/local/lsws/lsphp73/bin"
#define PHP_SBINDIR             "/usr/local/lsws/lsphp73/sbin"
#define PHP_MANDIR              "/usr/local/lsws/lsphp73/share/man"
#define PHP_LIBDIR              "/usr/local/lsws/lsphp73/lib/php"
#define PHP_DATADIR             "/usr/local/lsws/lsphp73/share/php/7.3"
#define PHP_SYSCONFDIR          "/usr/local/lsws/lsphp73/etc"
#define PHP_LOCALSTATEDIR       "/usr/local/lsws/lsphp73/var"
#define PHP_CONFIG_FILE_PATH    "/usr/local/lsws/lsphp73/etc/php/7.3/litespeed/"
#define PHP_CONFIG_FILE_SCAN_DIR    "/usr/local/lsws/lsphp73/etc/php/7.3/mods-available/"
