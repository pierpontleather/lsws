...
#define PHP_EXTENSION_DIR       "/usr/local/lsws/lsphp70/lib/php/20151012"
#define PHP_PREFIX              "/usr/local/lsws/lsphp70"
#define PHP_BINDIR              "/usr/local/lsws/lsphp70/bin"
#define PHP_SBINDIR             "/usr/local/lsws/lsphp70/sbin"
#define PHP_MANDIR              "/usr/local/lsws/lsphp70/share/man"
#define PHP_LIBDIR              "/usr/local/lsws/lsphp70/lib/php"
#define PHP_DATADIR             "/usr/local/lsws/lsphp70/share/php/7.0"
#define PHP_SYSCONFDIR          "/usr/local/lsws/lsphp70/etc"
#define PHP_LOCALSTATEDIR       "/usr/local/lsws/lsphp70/var"
#define PHP_CONFIG_FILE_PATH    "/usr/local/lsws/lsphp70/etc/php/7.0/litespeed/"
#define PHP_CONFIG_FILE_SCAN_DIR    "/usr/local/lsws/lsphp70/etc/php/7.0/mods-available/"
