...
#define PHP_EXTENSION_DIR       "/usr/local/lsws/lsphp72/lib/php/20170718"
#define PHP_PREFIX              "/usr/local/lsws/lsphp72"
#define PHP_BINDIR              "/usr/local/lsws/lsphp72/bin"
#define PHP_SBINDIR             "/usr/local/lsws/lsphp72/sbin"
#define PHP_MANDIR              "/usr/local/lsws/lsphp72/share/man"
#define PHP_LIBDIR              "/usr/local/lsws/lsphp72/lib/php"
#define PHP_DATADIR             "/usr/local/lsws/lsphp72/share/php/7.2"
#define PHP_SYSCONFDIR          "/usr/local/lsws/lsphp72/etc"
#define PHP_LOCALSTATEDIR       "/usr/local/lsws/lsphp72/var"
#define PHP_CONFIG_FILE_PATH    "/usr/local/lsws/lsphp72/etc/php/7.2/litespeed/"
#define PHP_CONFIG_FILE_SCAN_DIR    "/usr/local/lsws/lsphp72/etc/php/7.2/mods-available/"
